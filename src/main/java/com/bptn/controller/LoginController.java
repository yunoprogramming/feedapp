...
public class LoginController {
    ...
    public ResponseEntity<?> verifyUserCredentials(@RequestBody LoginRequest loginRequest)
            throws InvalidUserCredentialsException {
        LOGGER.debug("Login request received for username = {} & password = {}", loginRequest.getUsername(),
